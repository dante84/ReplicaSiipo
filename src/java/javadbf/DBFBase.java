...
//	UTF-8
	// los dbf tienen diferentes codificaciones, se usan diferentes para cada conector
	// original tenia 8859_1 
	// calificacionfinal Cp850
	// en cada RDR de cada conector se indica el charset a usar, ya que lso dbf varian
